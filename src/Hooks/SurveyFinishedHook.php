...
namespace EuF\ContaoSurveySendmail\Hooks;

use Contao\Controller;
use Contao\Input;
use Contao\System;
use EuF\ContaoSurveySendmail\Model\SurveyQuestionsModel;
use EuF\ContaoSurveySendmail\Model\SurveyResultsModel;
...
class SurveyFinishedHook extends Controller
{
    ...
    public function surveyFinished($surveydata)
    {
        ...
        /** @var SurveyQuestionsModel $objQuestions */
        ...
        // Auslesen der Werte
        $objResults = SurveyResultsModel::findBy('pin', Input::post('pin'));
